      ...
      <div class="w-1/2 flex items-center justify-center">
        <form @submit.prevent="submit">
          <div class="flex-col items-center flex font-size justify-center">
            <div
              style='font-family: "Edu AU VIC WA NT Dots", cursive;font-optical-sizing: auto;font-weight: 800;font-style: normal;user-select: none;'
              class=" ">
              Tizimga kirish
            </div>
            ...
            <button type="submit" :disabled="loading ? true : false" :class="loading ? 'animate-bounce opacity-55' : ''"
